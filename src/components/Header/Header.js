...
export default function Header() {
  return (
    <nav className="nav flex items-center justify-between flex-wrap bg-blue-400 p-6">
      ...
      {/*  <div className="flex items-center justify-center w-12 h-12 bg-blue-500 rounded-md cursor-pointer hover:bg-blue-700">
          ...
          <span className="logo font-semibold text-xl tracking-tight">AbsolutelyFlutiful</span>
        </div>
        <div className="block lg:hidden ">
          <button className="flex items-center px-3 py-2 border rounded text-white border-black">
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          <div className="text-md lg:flex-grow">
            ...
            <a href="/brands" className="block mt-4 lg:inline-block lg:mt-0 text-white mr-4">
              Brands
            </a>
            <a href="/productList" className="block mt-4 lg:inline-block lg:mt-0 text-white mr-4">
              Products
            </a>
          </div>
          ...
          <div>
            ...
            <label htmlFor="search" className="inline-block text-sm px-4 py-2 leading-none text-white border round border-black ml-2 mt-4 lg:mt-0">Search</label>
          </div>
        </div>
</nav>
